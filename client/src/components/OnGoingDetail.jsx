        ...
        <div className="relative w-full h-[150px] md:h-[200px] mb-8 overflow-hidden rounded-xl">
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-12">
            <h1 className="text-3xl md:text-4xl font-bold mb-2 flex items-center">
              <Clock className="h-6 w-6 mr-2 text-red-400" />
              Ongoing Anime
            </h1>
            <p className="text-gray-300 max-w-2xl">
              Stay up to date with the latest anime releases. New episodes added
              weekly.
            </p>
          </div>
        </div>
                      ...
                      <div className="relative w-full aspect-[2/3] overflow-hidden rounded-lg mb-2 bg-gray-800">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          <div className="absolute bottom-0 left-0 right-0 p-3">
                            <div className="bg-red-600 text-white text-xs font-medium px-2 py-1 rounded-sm inline-block mb-2">
